...
// TODO - clear out unused functions

func (e *StorageBlobExpander) expandRepositories(ctx context.Context, currentItem *TreeNode) ExpanderResult {
...
func (e *StorageBlobExpander) expandRepository(ctx context.Context, currentItem *TreeNode) ExpanderResult {
...
func (e *StorageBlobExpander) deleteRepository(ctx context.Context, currentItem *TreeNode) (bool, error) {
	loginServer := currentItem.Metadata["loginServer"]
	repository := currentItem.Metadata["repository"]
...
func (e *StorageBlobExpander) expandRepositoryTags(ctx context.Context, currentItem *TreeNode) ExpanderResult {
	loginServer := currentItem.Metadata["loginServer"]
	repository := currentItem.Metadata["repository"]
...
func (e *StorageBlobExpander) expandRepositoryTag(ctx context.Context, currentItem *TreeNode) ExpanderResult {
	loginServer := currentItem.Metadata["loginServer"]
	repository := currentItem.Metadata["repository"]
...
func (e *StorageBlobExpander) deleteRepositoryTag(ctx context.Context, currentItem *TreeNode) (bool, error) {
	loginServer := currentItem.Metadata["loginServer"]
	repository := currentItem.Metadata["repository"]
	tag := currentItem.Metadata["tag"]
...
func (e *StorageBlobExpander) expandRepositoryManifests(ctx context.Context, currentItem *TreeNode) ExpanderResult {
	loginServer := currentItem.Metadata["loginServer"]
	repository := currentItem.Metadata["repository"]
...
func (e *StorageBlobExpander) expandRepositoryManifest(ctx context.Context, currentItem *TreeNode) ExpanderResult {
	loginServer := currentItem.Metadata["loginServer"]
	repository := currentItem.Metadata["repository"]
...
func (e *StorageBlobExpander) deleteRepositoryManifest(ctx context.Context, currentItem *TreeNode) (bool, error) {
...
func (e *StorageBlobExpander) getCreateManifestNodeFunc(loginServer string, repository string) createItemNode {
...
func (e *StorageBlobExpander) getCreateTagNodeFunc(loginServer string, repository string) createItemNode {
	return func(currentItem *TreeNode, item string) *TreeNode {
		return &TreeNode{
			Parentid:  currentItem.ID,
			ID:        currentItem.ID + "/" + item,
...
func (e *StorageBlobExpander) getCreateManifestsNodeFunc(loginServer string, repository string, title string) createItemNode {
...
func (e *StorageBlobExpander) getCreateTagsNodeFunc(loginServer string, repository string, title string) createItemNode {
	return func(currentItem *TreeNode, lastItem string) *TreeNode {
		return &TreeNode{
			Parentid:  currentItem.ID,
			ID:        currentItem.ID + "/" + title,
...
func (e *StorageBlobExpander) expandNode(
	ctx context.Context,
...
func (e *StorageBlobExpander) getItemsForURL(ctx context.Context, url string, accessToken string, collectionPath string, itemPath string) (string, []string, error) {
...
func (e *StorageBlobExpander) doRequest(ctx context.Context, verb string, url string, accessToken string) ([]byte, error) {
...
func (e *StorageBlobExpander) getLoginServer(ctx context.Context, registryID string) (string, error) {
	data, err := e.armClient.DoRequest(ctx, "GET", registryID)
	if err != nil {
		return "", fmt.Errorf("Failed to get registry: " + err.Error() + registryID)
	}
...
func (e *StorageBlobExpander) getRegistryToken(ctx context.Context, loginServer string, scope string) (string, error) {
